...
export const products: Product[] = [
  ...
  },
  {
    ...
    sizes: "XS-XXL",
    price: "₹499",
    priceOptions: [{ label: "Kurti", price: 499, mrp: 999 }],
    pexelsId: 0,
    images: [
  ...
  },
  {
    ...
    sizes: "XS-XXL",
    price: "₹599",
    priceOptions: [{ label: "Kurti", price: 599, mrp: 1099 }],
    pexelsId: 0,
    images: [
  ...
  },
  {
    ...
    sizes: "XS-XXL",
    price: "₹549",
    priceOptions: [{ label: "Kurti", price: 549, mrp: 999 }],
    pexelsId: 0,
    images: [
  ...
  },
  {
    ...
    images: [
      ...
      "/product_images/GULNOOR_SET/IMG_7679.JPG",
      "/product_images/GULNOOR_SET/gulnoor-video.mp4",
      "/product_images/GULNOOR_SET/IMG_7689.JPG",
      "/product_images/GULNOOR_SET/IMG_6919.JPG",
      "/product_images/GULNOOR_SET/IMG_6929.JPG",
    ],
    desc: "Gulnoor by House of Srishti is an elegant coordinating set in premium 100% cotton, handcrafted for festive celebrations and special occasions. Soft, breathable and made to order, tailored to your measurements over WhatsApp.",
  },
  {
    slug: "laila-set",
    name: "Laila Set",
